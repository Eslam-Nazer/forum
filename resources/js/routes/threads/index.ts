...
* @see modules/Forum/Http/Controllers/ThreadController.php:70
...
* @see modules/Forum/Http/Controllers/ThreadController.php:78
* @route '/threads'
*/
...
* @see modules/Forum/Http/Controllers/ThreadController.php:129
* @route '/threads/{channel}/{id}'
*/
