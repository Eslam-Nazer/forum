...
* @see modules/Forum/Http/Controllers/ThreadController.php:38
* @route '/threads'
*/
...
* @see modules/Forum/Http/Controllers/ThreadController.php:92
...
* @see modules/Forum/Http/Controllers/ThreadController.php:127
* @route '/threads/{channel}/{id}'
*/
