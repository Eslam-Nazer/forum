...
* @see modules/Forum/Http/Controllers/ThreadController.php:36
* @route '/threads'
*/
...
* @see modules/Forum/Http/Controllers/ThreadController.php:54
...
* @see modules/Forum/Http/Controllers/ThreadController.php:62
* @route '/threads'
*/
...
* @see modules/Forum/Http/Controllers/ThreadController.php:77
