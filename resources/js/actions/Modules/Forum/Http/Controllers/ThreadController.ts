...
* @see modules/Forum/Http/Controllers/ThreadController.php:64
...
* @see modules/Forum/Http/Controllers/ThreadController.php:72
* @route '/threads'
*/
...
* @see modules/Forum/Http/Controllers/ThreadController.php:87
